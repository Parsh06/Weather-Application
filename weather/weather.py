...
class Weather:
    ...
    def __init__(self):
        ...
        self.root.config(bg="black")  # Change background color to black
        ...
        self.name = Label(self.root, text="City or Country Name", fg="dark blue", font=self.font)  # Change text color to dark blue
        self.name.place(x=140, y=45)

        self.loc = Text(self.root, width=25, height=2, bg="yellow", relief=GROOVE, borderwidth=2)  # Change input box color to yellow
        self.loc.place(x=140, y=70)
        self.loc.config(fg="dark blue")  # Change text color of input box to dark blue
